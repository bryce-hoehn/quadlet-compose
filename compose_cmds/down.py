"""compose_down - Stop services and remove quadlet files from compose.yaml."""
...
def compose_down(compose_file: str | None = None, **_kwargs) -> None:
    """Stop systemd services and remove quadlet files.

    Stops services using the appropriate target (pod, kube, or individual),
    then removes all associated quadlet files and reloads systemd.
    """
    ...
    # Remove all quadlet files derived from the compose file
    files_to_remove = []
